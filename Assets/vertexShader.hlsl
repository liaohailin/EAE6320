...
// Entry Point
//============
void main(in const float3 i_position_model : POSITION, in const float3 i_normal_model:NORMAL, in const float3 i_color : COLOR0, in const float2 i_uv : TEXCOORD0,
